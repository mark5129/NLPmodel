...
for model in models:
    ...
    if unassigned_rows:
        groups[group_id] = unassigned_rows
    ...
    # Rename group numbers from 1 to the number of groups
    group_mapping = {old_id: new_id for new_id, old_id in enumerate(groups.keys(), start=1)}
